...
function ll2poly(latlonArray, scaleFactor) {
  ...
  translate(width/2, height/3) //move the whole thing to the center of the screen
  translate(-scalar*width/1.5, -scalar*height/1.5) //move the origin point of the shape to the center instead of the top left corner
  scale(scaleFactor)
