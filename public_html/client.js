...
function ll2poly(latlonArray, scaleFactor) {
  ...
  tranlate(-scalar*width/2.5), -scalar*height/2.5) //move the origin point of the shape to the center instead of the top left corner based on scale and screensize
